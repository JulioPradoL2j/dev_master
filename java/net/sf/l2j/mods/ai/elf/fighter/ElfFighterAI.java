...
public class ElfFighterAI extends CombatBehaviorAI
{
	
	
	public ElfFighterAI(FakePlayer character)
	{
		super(character);
		LoadSkills();
	}
	...
	{
		return CombatKit.FIGHTER_BURST;
	}
	
	protected void LoadSkills()
	{
		combo = new SkillCombo(new SkillAction(getBestSkill(3)));
	}
