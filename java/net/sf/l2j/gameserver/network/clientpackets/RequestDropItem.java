...
public final class RequestDropItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (item == null || _count == 0 || !activeChar.validateItemManipulation(_objectId) || activeChar.isActiveAgathion() || (!Config.ALLOW_DISCARDITEM && !activeChar.isGM()) || !item.isDropable())
		{
