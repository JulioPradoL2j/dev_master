...
public class DatabaseMainFrame extends JFrame
{
	...
	private static void applyDarkTheme()
	{
	    ...
	    final Border roundedPad = BorderFactory.createCompoundBorder(
	            rounded, BorderFactory.createEmptyBorder(6, 10, 6, 10)
	    );
	    ...
	    UIManager.put("TextArea.border", BorderFactory.createCompoundBorder(
	            rounded, BorderFactory.createEmptyBorder(8, 10, 8, 10)
	    ));
	    ...
	    UIManager.put("ComboBox.border", BorderFactory.createCompoundBorder(
	            rounded, BorderFactory.createEmptyBorder(4, 8, 4, 8)
	    ));
