	...
	public void run()
	{
		if (this == SingletonHolder._instance)
		{
			...
			try
			{
				...
				{
					OfflinePlayerData.getInstance().storeOffliners();
					_log.info("Offline Players Table: Offline Players stored.");
				}
			}
			catch (Throwable t)
			{
			...
			try
			{
				...
				_log.info("Daily Reward Manager saved all received players.");
			}
			catch (Throwable t)
			{
			}
